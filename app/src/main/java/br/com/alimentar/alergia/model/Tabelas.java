...
public class Tabelas {
    ...
    public static List<Substancia> addSubstancias(Context context) {
        String[] substancias = {context.getString(R.string.substancia_amendorim), context.getString(R.string.substancia_cevada), context.getString(R.string.substancia_crustaceos),
                context.getString(R.string.substancia_leite), context.getString(R.string.substancia_gluten), context.getString(R.string.substancia_ovo),
                context.getString(R.string.substancia_oleoginosas), context.getString(R.string.substancia_peixe), context.getString(R.string.substancia_soja),
                context.getString(R.string.substancia_trigo)};
    ...
    public static String[] addCategorias(Context context) {
        String[] categorias = new String[]{context.getString(R.string.categoria_selecione_item), context.getString(R.string.categoria_bebidas), context.getString(R.string.categoria_biscoitos),
                context.getString(R.string.categoria_bolos), context.getString(R.string.categoria_congelados), context.getString(R.string.categoria_doces_sobremesas),
                context.getString(R.string.categoria_enlatados), context.getString(R.string.categoria_graos_cereais), context.getString(R.string.categoria_iorgute),
